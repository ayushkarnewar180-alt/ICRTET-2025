      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <div className="text-lg md:text-xl font-normal text-gray-600 mt-2">10th Edition</div>
          </h1>
          ...
          <div className="mt-12">
            <img src="/placeholder.svg?height=100&width=100" alt="Registration QR Code" className="mx-auto h-24 w-24" />
            <p className="text-sm text-gray-500 mt-2">Scan for Quick Registration</p>
          </div>
        </div>
      </div>
    </section>
